          ...
          projects: [
            {
              ...
              link: "",
              desciption: `The WRU Refs app is what all the WRU referees use to submit details about their games. These features include, disciplines and  
            ...
            },
            {
              ...
              link: "",
              desciption: `Teamsheet is an app designed for team managers to be able to submit their teams for up comming games. It also allows them to view 
              ...
              it was always expected to last longer than expected, meaning it was created with maintainability in mind.
              Within the past year, start on the upgrade in flutter began, this again with me being the main developer. It
              started as a one to one copy, but in flutter, however, with much consideration we moved to a new design.
              The new app was also going to integrate the Refs app into it`,
              images: [
                {
                ...
                },
                {
                  ...
                  imageUrl:
                    "/images/wru-teamsheets/TeamsheetFixture-submit-teamsheet-top.png",
                  imageSize: 350,
                },
                {
                  name: "Teamsheet Front Row Cover Submit",
                  imageUrl:
                    "/images/wru-teamsheets/TeamsheetFixture-submit-teamsheet-bottom.png",
                  imageSize: 350,
                },
                {
          ...
          projects: [
            {
              ...
              desciption: `
                ...
                The project also had a basic flutter app that was used to scan ticket QR codes for entry, tickets could also be manually
                entered
              `,
              images: [
                {
          ...
          projects: [
            {
              ...
              They also have an interactive map on the site, this allows visitors to find shops and cafes more easily, it was my job to maintain this area`,
              images: [
                {
                  name: "MHPA Area Map",
          ...
          projects: [
            {
              ...
              Students progress is tracked through a visual wheel, which could be updated different means; teachers can manually add progress or
              students can complete quizes. One of the main areas I worked on was the quiz section, this was a new area of the project which I layed the
              foundations for, then code reviewed any extra work that was done on it. Another major section was updating the site to make it WCAG 2.0 AA standards,
              this meant going through every page, making sure it had correct tags on it and was screen reader appropriate`,
              images: [
                {
                  name: "Wheel",
                ...
                },
                {
                  ...
                  imageUrl:
                    "/images/create-development/lesson-starter-landing.png",
                  imageSize: 1000,
                },
                {
                  name: "Lesson Starter Questions",
                  imageUrl:
                    "/images/create-development/lesson-starter-main.png",
                  imageSize: 1000,
                },
                {
                  name: "Lesson Starter Question",
                  imageUrl:
                    "/images/create-development/lesson-starter-question.png",
                  imageSize: 1000,
                },
                {
                  name: "Lesson Starter Multi-Select",
                  imageUrl:
                    "/images/create-development/lesson-starter-question-multi-select.png",
                  imageSize: 1000,
                },
                {
                  name: "Lesson Starter Feedback",
                  imageUrl:
                    "/images/create-development/lesson-starter-feedback.png",
                  imageSize: 1000,
                },
              ],
            },
            {
              ...
              desciption: `
              The Bursts website is a sales platform for a greenfield SaaS app that provides sports 
              education for primary school children through an AR app. Umbraco was integrated into this site to allow 
              the user to have a CMS. I was one of the main developers working to create the website, this included creating
              wireframes and basic designs for the customer
              `,
              images: [
                {
          ...
          projects: [
            {
              ...
              desciption: `
                ...
                It is not a small project by any means, however, I choose this to challange myself. It is also something that does not have many online 
                guides to help, proving that I would not just be following a tutorial
                It uses a cookie based authorisation system. I chose that over JWT as I have already worked with JWT tokens
              `,
              images: [
                {
                  name: "Landing Page",
                ...
                },
                {
                  ...
                  imageUrl:
                    "/images/personal/race-project/race-page-filtered.png",
                  imageSize: 1400,
                },
                {
                  name: "Not Logged In Race Modal",
                  imageUrl:
                    "/images/personal/race-project/race-page-popup-nologin.png",
                  imageSize: 600,
                },
                {
                  name: "Login",
                ...
                },
                {
                  ...
                  imageUrl:
                    "/images/personal/race-project/dashboard-create-race.png",
                  imageSize: 1400,
                },
                {
                  name: "Db Schema (Outdated)",
                  imageUrl:
                    "/images/personal/race-project/dbdiagram-outdated.png",
                  imageSize: 1000,
                },
                {
                  name: "You Track issue tracker",
                  imageUrl:
                    "/images/personal/race-project/you-track-issues.png",
                  imageSize: 1400,
                },
              ],
            },
                                ...
                                <div className={"mx-5"}>
                                  ...
                                  >
                                    {project.images.map((image) => (
                                      <div
                                        className={screenshot.screenshots}
                                        key={image.name}
                                      >
                                        <Button
                                          onClick={() =>
                                        ...
                                        >
                                          ...
                                          >
                                            <span
                                              className={
                                                "justify-center screenshots-text z-20 max-w-full text-wrap"
                                              }
                                            >
                                              {image.name}
                                            </span>
